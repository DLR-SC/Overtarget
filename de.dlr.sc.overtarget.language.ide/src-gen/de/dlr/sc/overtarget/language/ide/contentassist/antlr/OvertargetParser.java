...
public class OvertargetParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OvertargetGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getUnitAccess().getVersAlternatives_2_2_0(), "rule__Unit__VersAlternatives_2_2_0");
			...
			builder.put(grammarAccess.getRepositoryLocationAccess().getGroup_6_0(), "rule__RepositoryLocation__Group_6_0__0");
			...
			builder.put(grammarAccess.getUnitAccess().getSourceAssignment_2_0(), "rule__Unit__SourceAssignment_2_0");
			builder.put(grammarAccess.getUnitAccess().getVersAssignment_2_2(), "rule__Unit__VersAssignment_2_2");
			...
			builder.put(grammarAccess.getRepositoryLocationAccess().getAddAllAssignment_6_0_1(), "rule__RepositoryLocation__AddAllAssignment_6_0_1");
			builder.put(grammarAccess.getRepositoryLocationAccess().getUnitsAssignment_6_1(), "rule__RepositoryLocation__UnitsAssignment_6_1");
