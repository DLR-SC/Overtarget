...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.overtarget.language.targetmodel.Unit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnitItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Unit_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Unit_source_feature", "_UI_Unit_type"),
				 TargetmodelPackage.Literals.UNIT__SOURCE,
				 true,
				 false,
				 false,
	...
	protected void addVersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Unit_vers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Unit_vers_feature", "_UI_Unit_type"),
				 TargetmodelPackage.Literals.UNIT__VERS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Unit)object).getSource();
