...
/**
 * This is the item provider adapter for a {@link de.dlr.sc.overtarget.language.targetmodel.VariableDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableDefinitionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableDefinition_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableDefinition_value_feature", "_UI_VariableDefinition_type"),
				 TargetmodelPackage.Literals.VARIABLE_DEFINITION__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((VariableDefinition)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VariableDefinition.class)) {
			case TargetmodelPackage.VARIABLE_DEFINITION__VALUE:
